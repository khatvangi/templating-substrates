...
E26Q_STATE_A = np.array([0.50, 0.025, 0.45, 0.025])
...
def run_experiment():
    ...
    progress_path = RESULTS_DIR / "test_e_progress.txt"
...
def main():
    rows = run_experiment()
    save_csv(rows, RESULTS_DIR / "test_e_results.csv")
    plot_three_systems(rows, FIGURES_DIR / "test_e_three_systems.png")
    plot_periodicity(rows, FIGURES_DIR / "test_e_periodicity.png")
    (RESULTS_DIR / "test_e_README.md").write_text(README_TEXT)
